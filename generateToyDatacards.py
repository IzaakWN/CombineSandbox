...
def plothists(hobs,hists,verb=0):
  ...
  legend.Draw()
  canvas.SaveAs('hists.png')
  return canvas
  

def writehists(objs,subdir="cat1",verb=0):
  """Write histograms to ROOT file."""
  print(f">>> writehists")
  file = TFile.Open('hists.root','RECREATE')
...
def main(args):
  ...
  canvas = plothists(hobs,hists,verb=args.verbosity)
  writehists([canvas,hobs]+hists,verb=args.verbosity)
  canvas.Close()
  createdatacard("hists.root",outdir="output",verb=args.verbosity)
